...
source_url: https://www.idbi.bank.in/idbi-bank-mobile-banking-faq.aspx
---
...
* Mobile Banking
* [Go Mobile+ App (Android and iOS)](go_mobile_app_android_version.aspx)
* [NUUP - \*99\*49#](idbi-bank-mobile-banking-ussd.aspx)
* [Mobile banking manual](pdf/Mobile-banking-manual.pdf)
* [FAQs](idbi-bank-mobile-banking-faq.aspx)
...
What are the eligibility criteria to avail the Mobile Banking Services?
...
I am already registered for and using mobile banking service. Do I need to re-register for Go Mobile+ App?

Existing Mobile Banking Registered users can directly download the new Go Mobile+ App and activate the App.

How do I install and activate the APP on my handset?
...
You should have a GPRS / Wi-Fi enabled (internet connectivity) Smart phone with Android version 6.0 & above / iOS version 13 & above.

I have a dual SIM phone. How do I activate the app on my phone?
...
What is the daily transaction limit for this new App?
...
How much time will it take for a new beneficiary to be active for transactions?
...
In which case does the activation process fail ?

If the mobile number in the handset does not match your registered mobile number, then the activation fails.

I have downloaded the application, when I click on Activate App, I get a message that “You are not registered for Mobile Banking Services.” What should I do?
...
What if I get disconnected or my mobile phone switches off or I get ‘Sorry we are unable to process your request’ message while performing a transaction?
...
I have forgotten my MPIN, what should I do?
...
I have forgotten my MPIN, when I am entering my Customer ID it's showing an error that activation failed. Why is that?

While resetting MPIN, you need to activate using mobile number which is registered with the Bank.

I have entered wrong Debit Card details 6 times. What will happen now?
...
If my Debit Card is blocked / Off, Will I be able to activate the app?

No, you need to unblock/On your Debit Card (through Abhay / Net Banking) first and then use it for activation of app.

What if I do not have Net Banking access or Debit Card, Can I use this service?
...
Do I need to de-register the old Mobile Banking application in order to use the new one?
...
How to access ‘Credit Card Services’ in Go Mobile+ App?
...
What precautions do I need to take for accessing Mobile Banking?
...
What process needs to be followed in case GO Mobile+ Application has to be blocked?
